...
# Set Directory
```{r}
setwd("~/OneDrive - UW/Documents/eScience Institute/CRDC/SC_data")
...
files <- list.files(path = "C:/Users/Riddhi/Downloads/2017-18-crdc-data (1)/2017-18-crdc-data-corrected-publication 2/2017-18 Public-Use Files/Data/SCH/CRDC/CSV", pattern = "*.csv", full.names = T)
...
data <- setNames(data, sub("\\.csv", "", list.files("C:/Users/Riddhi/Downloads/2017-18-crdc-data (1)/2017-18-crdc-data-corrected-publication 2/2017-18 Public-Use Files/Data/SCH/CRDC/CSV", pattern = "\\.csv")))
